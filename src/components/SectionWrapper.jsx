...
const SectionWrapper = ({
  ...
  return (
    ...
    >
      <div
        className={`flex items-center ${reverse ? styles.boxReverseClass : styles.boxClass
      ...
      >
        ...
        >
          <h1
            className={` ${reverse ? styles.blackText : styles.whiteText} ${styles.h1Text
              }`}
          >
            {title}
          </h1>
          <p
            className={` ${reverse ? styles.blackText : styles.whiteText} ${styles.descriptionText
              }`}
          >
            {description}
          </p>
